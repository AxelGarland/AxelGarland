...
/** "alutit", "giuson", "jabberwocky", and "facettes" have their own bespoke pages — excluded
 *  here so those routes don't collide with this dynamic one. */
const BESPOKE_SLUGS = ["alutit", "giuson", "jabberwocky", "facettes"];
