...
export function IllustrationWork() {
  ...
  return (
    <>
      <section id="work" className="bg-surface py-20 md:py-32">
          ...
          <MotionReveal>
            <div className="mb-14 flex flex-wrap items-end justify-between gap-8 md:mb-20">
              <div>
                ...
                <h2 className="max-w-[20ch] font-display text-3xl font-semibold leading-[1.1] text-ink sm:text-4xl">
                  Projects that
                  <br />
                  <em className="italic text-accent">move things forward</em>
                </h2>
              </div>
              <p className="max-w-[38ch] self-end text-base leading-relaxed text-ink-muted">
